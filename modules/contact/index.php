				...
				<div data-aos="flip-left" class="col-md-6 contact-left">
					...
					<div class="contact-info">
						...
						<div class="contact-info-right">
							<h5>Address</h5>
							<p>Jl. Puri Widya Kencana No.JT2/28<br>
								<span>Lidah Kulon, Lakarsantri, Surabaya.</span>
					...
					<div class="contact-info">
						...
						<div class="contact-info-right">
							<h5>E-Mail</h5>
							<ul>
								<li><a href="mailto:rohitsankhla1999@gmail.com">daffafauzan@gmail.com</a></li>
							</ul>
						</div>
						<div class="clearfix"> </div>
					</div>
